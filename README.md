...
The jar file will be named as `core-0.3.1.jar` and in the `target` folder of the project.
...
```
> java -classpath core-0.3.1.jar org.vanilladb.core.server.StartUp {DB Name}
```
...
```
> java -classpath core-0.3.1.jar org.vanilladb.core.util.ConsoleSQLInterpreter
```
...
```
> java -Dorg.vanilladb.core.config.file={path to vanilladb.properties} -classpath core-0.3.1.jar org.vanilladb.core.server.StartUp {DB Name}
```
