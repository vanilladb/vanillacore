...
public class FileTest {
    ...
    private static final VarcharConstant TEST_VARCHAR = new VarcharConstant("abcdefghijklmnopqrstuvwxyz0123456789");
    ...
    public void testReadWriteAppend() {
        ...
        p1.read(blk);
        System.out.println(p1.getVal(0, INTEGER).equals(TEST_INT_123));
        System.out.println(p1.getVal(INT_SIZE, INTEGER).equals(TEST_INT_456));
        
        // read block 0 with another page and assert
        p2.read(blk);
        System.out.println(p2.getVal(0, INTEGER).equals(TEST_INT_123));
        System.out.println(p2.getVal(INT_SIZE, INTEGER).equals(TEST_INT_456));
        assertTrue("*****FileTest: bad getInt", p2.getVal(0, INTEGER).equals(TEST_INT_123) && p2.getVal(INT_SIZE, INTEGER).equals(TEST_INT_456));
        ...
        System.out.println(lastblock + 1 == blk2.number());
        ...
        System.out.println(p2.getVal(0, INTEGER).equals(TEST_INT_123));
        System.out.println(p2.getVal(INT_SIZE, INTEGER).equals(TEST_INT_456));
        assertTrue("*****FileTest: bad read", p2.getVal(0, INTEGER).equals(TEST_INT_123) && p2.getVal(INT_SIZE, INTEGER).equals(TEST_INT_456));
    }
    ...
    public void testFileList() {
        ...
        p1.write(blk);
        System.out.println(15 == fm.size(filename));
    ...
    public void testSetAndGet() {
        ...
        assertTrue("*****FileTest: bad page get/set",
        ...
        assertTrue("*****FileTest: bad overlapping getInt",
                (!p1.getVal(0, INTEGER).equals(TEST_INT_123)) &&
        ...
        assertTrue("*****FileTest: bad contiguous getInt",
                p2.getVal(0, INTEGER).equals(TEST_INT_123) &&
                          p2.getVal(INT_SIZE, INTEGER).equals(TEST_INT_456) &&
                          p2.getVal(INT_SIZE * 2, INTEGER).equals(TEST_INT_789));
        ...
        assertTrue("*****FileTest: bad contiguous getString",
                p3.getVal(0, VARCHAR).equals(TEST_VARCHAR) &&
                          p3.getVal(TEST_VARCHAR_SIZE, VARCHAR).equals(TEST_VARCHAR) &&
                          p3.getVal(2 * TEST_VARCHAR_SIZE, VARCHAR).equals(TEST_VARCHAR));
    }
    ...
    public void testBlockId() {
        ...
        assertTrue("*****FileTest: bad block equals", !b1.equals(b2) && b1.equals(b3) && !b1.equals(b4));
        
        Map<BlockId, String> m = new HashMap<BlockId, String>();
        m.put(b1, "block 1");
        m.put(b2, "block 2");
        assertTrue("*****FileTest: bad block hashcode", m.get(b1).equals("block 1") && m.get(b3).equals("block 1") && m.get(b4) == null);
