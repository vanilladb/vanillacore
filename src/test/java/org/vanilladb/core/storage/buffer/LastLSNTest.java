...
public class LastLSNTest {
  ...
  public static void init() {
    ...
    if (logger.isLoggable(Level.INFO)) logger.info("BEGIN LAST LSN TEST");
  }

  @AfterClass
  public static void finish() {
    if (logger.isLoggable(Level.INFO)) logger.info("FINISH LAST LSN TEST");
  }
   ...
   *
   * <p>[0, 'YS', 10l, 0.0, 1.0, 'netdb', 'kerker', 101]
   *
   * @author SLMT
   */
