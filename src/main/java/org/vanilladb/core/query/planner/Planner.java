...
public class Planner {
    ...
    public Planner(QueryPlanner qPlanner, UpdatePlanner uPlanner, ShowPlanner showPlanner) {
    ...
    public Plan executeShowPlan(String qry, Transaction tx) {
        if(qry.toLowerCase().startsWith("desc")){
            return showPlanner.descTable(qry, tx);
        }else if(qry.toLowerCase().startsWith("show")){
            return showPlanner.showTables(qry, tx);
        }
        return showPlanner.showTables(qry, tx);
    }
